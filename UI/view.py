...
class View:
    ...
    def load_interface(self):
        ...
        # TODO
        self.pulsante_cammino_minimo = ft.ElevatedButton(text = "Cammino Minimo",
        ...
        self.lista_visualizzazione_3 = ft.ListView(expand=1, spacing = 10,padding = 30, auto_scroll=False)
